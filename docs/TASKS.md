...
| T04A | [创造房屋](./tasks/T04A_CREATE_HOUSE.md) | T04 | B 核心切片 | completed |
| T05 | [背包、Toolbar、Itembar 与手持物](./tasks/T05_INVENTORY_TOOLBAR_ITEMBAR.md) | T04A | B 核心切片 | completed |
...
| T10 | [时间、天气、状态、睡眠与光照](./tasks/T10_TIME_AND_WEATHER.md) | T08, T09 | C 活世界 | completed |
...
| T13A | [场景物件、NPC 交互与对话气泡](./tasks/T13A_INTERACTION_AND_DIALOGUE.md) | T04A, T10, T12, T13 | C 活世界 | completed |
| T14 | [版本化保存与读取](./tasks/T14_SAVE_AND_LOAD.md) | T11, T13, T13A | D 完整性 | pending |
